                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php if ($this->session->userdata('hakakses') == 'kadin') { ?>
                            <form class="form-label-left input_mask" action="<?= base_url('kadin\pilih_tanggal_transaksi') ?>" method="POST">
                            <?php } elseif ($this->session->userdata('hakakses') == 'bendahara') { ?>
                                <form class="form-label-left input_mask" action="<?= base_url('bendahara\pilih_tanggal_transaksi') ?>" method="POST">
                                <?php } ?>
            ...
            <div class="col-md-4">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php if ($this->session->userdata('hakakses') == 'kadin') { ?>
                            <form class="form-label-left input_mask" action="<?= base_url('kadin\pilih_bulan_transaksi') ?>" method="POST">
                            <?php } elseif ($this->session->userdata('hakakses') == 'bendahara') { ?>
                                <form class="form-label-left input_mask" action="<?= base_url('bendahara\pilih_bulan_transaksi') ?>" method="POST">
                                <?php } ?>
            ...
            <div class="col-md-4">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <?php if ($this->session->userdata('hakakses') == 'kadin') { ?>
                            <form class="form-label-left input_mask" action="<?= base_url('kadin\pilih_tahun_transaksi') ?>" method="POST">
                            <?php } elseif ($this->session->userdata('hakakses') == 'bendahara') { ?>
                                <form class="form-label-left input_mask" action="<?= base_url('bendahara\pilih_tahun_transaksi') ?>" method="POST">
                                <?php } ?>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 ">Tahun<span class="required">*</span>
                                        </label>
