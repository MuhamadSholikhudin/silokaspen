                    ...
                    <table class="table  table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($bku as $sal) : ?>
                                <tr>
                                    <th scope="row"><?= $no++ ?></th>
                                    <td><a href="<?= base_url('kadin/laporan_bku/') . $sal->kdsaldo ?>"> Laporan Buku Kas Umum Bulan <?= $sal->periodebulan ?>&nbsp;<?= $sal->periodetahun ?></a></td>
                                    <td>
                                        <?php if ($sal->status == 2) { ?>
                                            <a href="<?= base_url('kadin/cetak_bku/') . $sal->kdsaldo ?>" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-warning">Cetak</a>
                                        <?php
                                        } else { ?>
